...
<c:forEach var="vo" items="${list}">
  ...
  <form action="carList.do?center=rentcar/rentCarList.jsp" method="post">
  ...
  <button onclick="location.href='carList.do?center=rentcar/rentCarList.jsp&category=0'">전체 검색</button>
